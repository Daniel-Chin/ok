...
switch (stage) {
	...
	case -4:
		// repeated
		draw_set_font(global.font_48);
		draw_rectangle(0, 0, room_width, room_height, false);
		draw_set_color(c_black);
		draw_set_alpha(timer / 1);
		draw_text_transformed(room_width * .7, room_height * .7, "OK Studios", 1, 1, 0);
	...
	case -1:
		...
		draw_set_color(c_black);
		draw_set_alpha(timer / 1);
		draw_text_transformed(room_width * .6, room_height * .7, "Global Game Jam, 2020", 1, 1, 0);
		draw_set_color(c_white);
		draw_set_alpha(1);
		break;
	case 0:
